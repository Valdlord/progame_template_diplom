...
<!--                        <div class="col-md-6 offset-md-3">-->
<!--                            <div class="form-floating mb-3">-->
<!--                                <input type="tel" name="tel" class="form-control" id="tel" placeholder="phone" value="--><?//= get_field_value('tel') ?><!--">-->
<!--                                <label class="required" for="tel">--><?php //__('cart_view_email_input'); ?><!--</label>-->
<!--                            </div>-->
<!--                        </div>-->
